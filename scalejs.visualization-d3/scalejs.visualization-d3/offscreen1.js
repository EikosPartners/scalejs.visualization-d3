...
define([
    ...
    return function () {
        ...
        function testHammer(event) {
            ...
            } else if (event.type === "pinch" || event.type === "transformend") {// || event.type === "rotate") {
                // Pinch to Zoom && Rotate (rotate event isn't listened to for now, but pinch does its operations)
