            ...
            return function (d) {
                ...
                if (newFill !== this.backFill) {
                    return function (t) {
                        this.left = interpX(t);
                        this.top = interpY(t);
                        this.width = interpWidth(t);
                        this.height = interpHeight(t);
                        this.backFill = interpFill(t);
        ...
        function arcTween() {
            return function (d) {
                ...
                return function (t) { // Interpolate arc:
                    ...
                    this.old.x = interpX(t);
                    this.old.y = interpY(t);
                    this.old.dx = interpDX(t);
                    this.old.dy = interpDY(t);
                    this.fill = interpFill(t);
                    this.opacity = interpOpacity(t);
    ...
    function init(
        ...
        function setVisualization(type) {
            ...
            visualization.parameters = computed(function () {
                visualizationParams = unwrap(parameters[type]);
            });
